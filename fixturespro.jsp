...
try{
	...
	String d=request.getParameter("pos");
Class.forName("com.mysql.jdbc.Driver");  
Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/foot","root","");  
//here sonoo is database name, root is username and password  
  
String q="insert into fixtures(hight,weight,skill,position) values(?,?,?,?)";  
...
out.println("<script>alert('sucessfully registered');window.location.href='updation1.jsp';</script>");  
